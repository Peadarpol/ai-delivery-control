...
- v1.9 (2026-08-04, Gemini): Updates footnote [^1] to reference the completed test-suite integrity audit (8 test fixes, zero H-03 gaming signatures) and the bounded test reorganization moving `tests/unit/` to `tests/integration/` with stem-collision resolution.
