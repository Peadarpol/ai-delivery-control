...
T1-H-08 (branch-isolated model roster in compiled wiki — no undelivered dependencies, low effort)
T1-L-10 (false positive → eval regression pipeline — no undelivered dependencies, low effort)
T1-G-07 (structured SKIP_REASON enforcement — depends T1-L-10, low effort)
T1-G-06 (structured rebuttal protocol — depends T1-E-02 ✅ T1-G-03 ✅, medium effort)
...
Medium: T1-B-04/05/06/07, T1-I-02, T1-J-03/04
