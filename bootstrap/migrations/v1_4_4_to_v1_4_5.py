...
class MigrationV1_4_4_to_V1_4_5(VersionRewriteMixin, MigrationProtocol):
    from_version = "1.4.4"
    to_version = "1.4.5"

    def migrate(self, config_path: Path) -> None:
        """Bump framework version from v1.4.4 to v1.4.5 in config.yaml."""
        self._rewrite_version(config_path, self.from_version, self.to_version)

    def downgrade(self, config_path: Path) -> None:
        """Revert framework version from v1.4.5 back to v1.4.4 in config.yaml."""
...
v1_4_4_to_v1_4_5_migration = MigrationV1_4_4_to_V1_4_5()
from_version = MigrationV1_4_4_to_V1_4_5.from_version
to_version = MigrationV1_4_4_to_V1_4_5.to_version
migrate = v1_4_4_to_v1_4_5_migration.migrate
downgrade = v1_4_4_to_v1_4_5_migration.downgrade
